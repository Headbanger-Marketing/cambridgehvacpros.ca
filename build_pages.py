...
SVC_PHOTO_FALLBACK = ("wp/London-Ontario-HVAC-technician.png", "Cambridge HVAC Pros HVAC technician in service")
SVC_PHOTO = {
...
<section class="{hero_class()}">
  ...
  <div class="container">
    <div class="hero__copy reveal">
      ...
      <h1>Cambridge HVAC Pros, Expert Heating &amp; Cooling Repair in <span class="accent">{CITY}, ON</span></h1>
  ...
  <div class="container">
    <div class="split">
      ...
      <div class="split__media reveal d1">
        <img class="media-photo" src="/assets/img/wp/London-Ontario-HVAC-technician.png" alt="Cambridge HVAC Pros HVAC technician servicing a system" width="640" height="640" loading="lazy" decoding="async">

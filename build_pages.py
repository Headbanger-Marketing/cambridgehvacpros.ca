  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p>At Cambridge HVAC Pros, we believe every family deserves a comfortable, healthy home. As a family-oriented business based in Cambridge, Ontario, our mission is simple: keep your home comfortable through every season with the same high standard of care we'd expect for our own households.</p>
...
<section class="page-hero">
  <div class="container">
    ...
    <p>Is your air conditioner making a strange noise? Ready to upgrade your furnace before winter? Whatever your home comfort need, the Cambridge HVAC Pros team is ready to help, without the stress.</p>
  </div>
</section>
  ...
  <div class="container">
    <article class="article reveal">
      ...
      <div class="note-banner" style="margin-top:30px;background:var(--bg-alt);border:1px solid var(--line);color:var(--body)">
        ...
        <a href="/contact/">Request a free quote</a> and a local Cambridge technician will get back to you fast, we're here 24/7.
      </div>
    </article>
  </div>
</section>
